...
public class TestDataProvider {
	...
	public static Object[][] provideUserPassword()
	{
		...
		// Deceleration of array of ob/ject 
	...
	{
		String[][] validEmail = {{Configs.getConfig("validEmail")}};
		return validEmail;
	}
	...
	{
		String[][] validEmail = {{Configs.getConfig("validEmail"),Configs.getConfig("validPassword")}};
		return validEmail;
	}

	@DataProvider(name="signUpWithValidInformations")
	public static Object[][] signUpWithValidInformations() 
	{
		double randomNo = Math.random() * 1000 + 1;
		String[][] validEmail = {{Configs.getConfig("validName"), Configs.getConfig("randomEmailPrefix")+randomNo+Configs.getConfig("randomEmailSuffix"), Configs.getConfig("validPassword")}}; 
		return validEmail;
	}
