...
import com.app.android.AndroidTest;
...

{
	...
	{
		// TODO Auto-generated method stub
		//ExtentReportCustom.createReport(itr.getName(), itr.getMethod().getGroups().toString(), itr.getMethod().getDescription(), "SKIPPED", "Method skipped");
	}
